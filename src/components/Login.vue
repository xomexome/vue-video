                ...
                <form  enctype='multipart/form-data'>
                    <div class="input">
                        <div class="input_wrap">
                            ...
                            <input type="text" spellcheck ='false' v-model.trim="userName" @keyup.enter="signin" name="userName" placeholder="用户名">
                        </div>
                        <div class="input_wrap">
                            <i class="iconfont icon-mima1"></i>
                            <input type="password" spellcheck="false" v-model="password" @keyup.enter="signin" name="password" placeholder="密码">
                        </div>
                        <div class="input_wrap">
                            <i class="iconfont icon-yanzhengma1"></i>
                            <input type="text" spellcheck="false" v-model="yzm" @keyup.enter="signin" name="yzm" placeholder="验证码">
...
export default {
    ...
    methods:{
        ...
        signin(){
            ...
            if (this.yzm.toLowerCase() != this.yzmTest) {
                 this.$toast({
                    icon:'fail',
                    message:'验证码错误'
                }) 
